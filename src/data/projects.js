export const projects = [
  {
    ...
    highlights: [
      'True First Person implementation with a fully visible body',
      'Fully network-replicated spaceship movement system',
      'Replicated custom gravity system',
      'Fully replicated power grid — generators, power panels, and electrical devices',
      'Replicated dynamic goals system (team goals and personal goals)',
      'Full integration with Inventory Framework via GAS',
      'Modular equipment system for separate hands, easily extendable',
      'AI behaviour trees with Dynamic Navigation System plugin',
